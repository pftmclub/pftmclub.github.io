...
if(!o.hdingwidth) {o.hdingwidth=470};
if(!o.hdingheight) {o.hdingheight=23};
if(!o.hdingindent) {o.hdingindent=1};
if(!o.linkheight) {o.linkheight=11};
...
if(!o.bordercolor) {o.bordercolor="white"};
if(!o.borderstyle) {o.borderstyle="solid"};
if(!o.barcolor) {o.barcolor="#0059BD"};
if(!o.barbgcolor) {o.barbgcolor="#DDECFE"};
...
if(!o.hdingcolor) {o.hdingcolor="#0059BD"};
if(!o.hdingbgcolor) {o.hdingbgcolor="#DDECFE"};
